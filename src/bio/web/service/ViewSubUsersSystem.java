 ...
 */
            ...
            /**
            *  ViewSubUsersSystem bean class
            */
            @SuppressWarnings({"unchecked","unused"})
        
        public  class ViewSubUsersSystem
                  ...
                  if (serializeType){
                   ...
                   if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)){
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           namespacePrefix+":viewSubUsersSystem",
                           xmlWriter);
                   } else {
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           "viewSubUsersSystem",
    ...
    public static class Factory{
        ...
        */
        public static ViewSubUsersSystem parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception{
            ViewSubUsersSystem object =
                new ViewSubUsersSystem();
                ...
                if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance","type")!=null){
                  ...
                  if (fullTypeName!=null){
                    ...
                    java.lang.String type = fullTypeName.substring(fullTypeName.indexOf(":")+1);
                            ...
                            if (!"viewSubUsersSystem".equals(type)){
                                //find namespace for the prefix
                                java.lang.String nsUri = reader.getNamespaceContext().getNamespaceURI(nsPrefix);
                                return (ViewSubUsersSystem)bio.web.service.ExtensionMapper.getTypeObject(
                                     nsUri,type,reader);
                              }
