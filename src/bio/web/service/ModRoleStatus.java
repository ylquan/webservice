 ...
 */
            ...
            /**
            *  ModRoleStatus bean class
            */
            @SuppressWarnings({"unchecked","unused"})
        
        public  class ModRoleStatus
    ...
    public static class Factory{
        ...
        */
        public static ModRoleStatus parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception{
            ModRoleStatus object =
                new ModRoleStatus();
                ...
                if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance","type")!=null){
                  ...
                  if (fullTypeName!=null){
                    ...
                    java.lang.String type = fullTypeName.substring(fullTypeName.indexOf(":")+1);
                            ...
                            if (!"modRoleStatus".equals(type)){
                                //find namespace for the prefix
                                java.lang.String nsUri = reader.getNamespaceContext().getNamespaceURI(nsPrefix);
                                return (ModRoleStatus)bio.web.service.ExtensionMapper.getTypeObject(
                                     nsUri,type,reader);
                              }
