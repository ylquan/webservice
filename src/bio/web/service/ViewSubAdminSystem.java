 ...
 */
            ...
            /**
            *  ViewSubAdminSystem bean class
            */
            @SuppressWarnings({"unchecked","unused"})
        
        public  class ViewSubAdminSystem
                  ...
                  if (serializeType){
                   ...
                   if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)){
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           namespacePrefix+":viewSubAdminSystem",
                           xmlWriter);
                   } else {
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           "viewSubAdminSystem",
    ...
    public static class Factory{
        ...
        */
        public static ViewSubAdminSystem parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception{
            ViewSubAdminSystem object =
                new ViewSubAdminSystem();
                ...
                if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance","type")!=null){
                  ...
                  if (fullTypeName!=null){
                    ...
                    java.lang.String type = fullTypeName.substring(fullTypeName.indexOf(":")+1);
                            ...
                            if (!"viewSubAdminSystem".equals(type)){
                                //find namespace for the prefix
                                java.lang.String nsUri = reader.getNamespaceContext().getNamespaceURI(nsPrefix);
                                return (ViewSubAdminSystem)bio.web.service.ExtensionMapper.getTypeObject(
                                     nsUri,type,reader);
                              }
