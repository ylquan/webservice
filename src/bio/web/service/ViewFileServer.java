 ...
 */
            ...
            /**
            *  ViewFileServer bean class
            */
            @SuppressWarnings({"unchecked","unused"})
        
        public  class ViewFileServer
                  ...
                  if (serializeType){
                   ...
                   if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)){
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           namespacePrefix+":viewFileServer",
                           xmlWriter);
                   } else {
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           "viewFileServer",
    ...
    public static class Factory{
        ...
        */
        public static ViewFileServer parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception{
            ViewFileServer object =
                new ViewFileServer();
                ...
                if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance","type")!=null){
                  ...
                  if (fullTypeName!=null){
                    ...
                    java.lang.String type = fullTypeName.substring(fullTypeName.indexOf(":")+1);
                            ...
                            if (!"viewFileServer".equals(type)){
                                //find namespace for the prefix
                                java.lang.String nsUri = reader.getNamespaceContext().getNamespaceURI(nsPrefix);
                                return (ViewFileServer)bio.web.service.ExtensionMapper.getTypeObject(
                                     nsUri,type,reader);
                              }
