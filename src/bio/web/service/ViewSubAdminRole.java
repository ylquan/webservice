 ...
 */
            ...
            /**
            *  ViewSubAdminRole bean class
            */
            @SuppressWarnings({"unchecked","unused"})
        
        public  class ViewSubAdminRole
                  ...
                  if (serializeType){
                   ...
                   if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)){
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           namespacePrefix+":viewSubAdminRole",
                           xmlWriter);
                   } else {
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           "viewSubAdminRole",
    ...
    public static class Factory{
        ...
        */
        public static ViewSubAdminRole parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception{
            ViewSubAdminRole object =
                new ViewSubAdminRole();
                ...
                if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance","type")!=null){
                  ...
                  if (fullTypeName!=null){
                    ...
                    java.lang.String type = fullTypeName.substring(fullTypeName.indexOf(":")+1);
                            ...
                            if (!"viewSubAdminRole".equals(type)){
                                //find namespace for the prefix
                                java.lang.String nsUri = reader.getNamespaceContext().getNamespaceURI(nsPrefix);
                                return (ViewSubAdminRole)bio.web.service.ExtensionMapper.getTypeObject(
                                     nsUri,type,reader);
                              }
