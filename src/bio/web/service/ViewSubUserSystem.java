 ...
 */
            ...
            /**
            *  ViewSubUserSystem bean class
            */
            @SuppressWarnings({"unchecked","unused"})
        
        public  class ViewSubUserSystem
                  ...
                  if (serializeType){
                   ...
                   if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)){
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           namespacePrefix+":viewSubUserSystem",
                           xmlWriter);
                   } else {
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           "viewSubUserSystem",
    ...
    public static class Factory{
        ...
        */
        public static ViewSubUserSystem parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception{
            ViewSubUserSystem object =
                new ViewSubUserSystem();
                ...
                if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance","type")!=null){
                  ...
                  if (fullTypeName!=null){
                    ...
                    java.lang.String type = fullTypeName.substring(fullTypeName.indexOf(":")+1);
                            ...
                            if (!"viewSubUserSystem".equals(type)){
                                //find namespace for the prefix
                                java.lang.String nsUri = reader.getNamespaceContext().getNamespaceURI(nsPrefix);
                                return (ViewSubUserSystem)bio.web.service.ExtensionMapper.getTypeObject(
                                     nsUri,type,reader);
                              }
