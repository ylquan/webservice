 ...
 */
            ...
            /**
            *  ViewSubRole bean class
            */
            @SuppressWarnings({"unchecked","unused"})
        
        public  class ViewSubRole
    ...
    public static class Factory{
        ...
        */
        public static ViewSubRole parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception{
            ViewSubRole object =
                new ViewSubRole();
                ...
                if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance","type")!=null){
                  ...
                  if (fullTypeName!=null){
                    ...
                    java.lang.String type = fullTypeName.substring(fullTypeName.indexOf(":")+1);
                            ...
                            if (!"viewSubRole".equals(type)){
                                //find namespace for the prefix
                                java.lang.String nsUri = reader.getNamespaceContext().getNamespaceURI(nsPrefix);
                                return (ViewSubRole)bio.web.service.ExtensionMapper.getTypeObject(
                                     nsUri,type,reader);
                              }
