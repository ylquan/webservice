 ...
 */
            ...
            /**
            *  DelFeedback bean class
            */
            @SuppressWarnings({"unchecked","unused"})
        
        public  class DelFeedback
    ...
    public static class Factory{
        ...
        */
        public static DelFeedback parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception{
            DelFeedback object =
                new DelFeedback();
                ...
                if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance","type")!=null){
                  ...
                  if (fullTypeName!=null){
                    ...
                    java.lang.String type = fullTypeName.substring(fullTypeName.indexOf(":")+1);
                            ...
                            if (!"delFeedback".equals(type)){
                                //find namespace for the prefix
                                java.lang.String nsUri = reader.getNamespaceContext().getNamespaceURI(nsPrefix);
                                return (DelFeedback)bio.web.service.ExtensionMapper.getTypeObject(
                                     nsUri,type,reader);
                              }
