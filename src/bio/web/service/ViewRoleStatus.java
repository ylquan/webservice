 ...
 */
            ...
            /**
            *  ViewRoleStatus bean class
            */
            @SuppressWarnings({"unchecked","unused"})
        
        public  class ViewRoleStatus
                  ...
                  if (serializeType){
                   ...
                   if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)){
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           namespacePrefix+":viewRoleStatus",
                           xmlWriter);
                   } else {
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           "viewRoleStatus",
    ...
    public static class Factory{
        ...
        */
        public static ViewRoleStatus parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception{
            ViewRoleStatus object =
                new ViewRoleStatus();
                ...
                if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance","type")!=null){
                  ...
                  if (fullTypeName!=null){
                    ...
                    java.lang.String type = fullTypeName.substring(fullTypeName.indexOf(":")+1);
                            ...
                            if (!"viewRoleStatus".equals(type)){
                                //find namespace for the prefix
                                java.lang.String nsUri = reader.getNamespaceContext().getNamespaceURI(nsPrefix);
                                return (ViewRoleStatus)bio.web.service.ExtensionMapper.getTypeObject(
                                     nsUri,type,reader);
                              }
