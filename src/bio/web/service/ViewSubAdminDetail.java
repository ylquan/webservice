 ...
 */
            ...
            /**
            *  ViewSubAdminDetail bean class
            */
            @SuppressWarnings({"unchecked","unused"})
        
        public  class ViewSubAdminDetail
                  ...
                  if (serializeType){
                   ...
                   if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)){
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           namespacePrefix+":viewSubAdminDetail",
                           xmlWriter);
                   } else {
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           "viewSubAdminDetail",
    ...
    public static class Factory{
        ...
        */
        public static ViewSubAdminDetail parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception{
            ViewSubAdminDetail object =
                new ViewSubAdminDetail();
                ...
                if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance","type")!=null){
                  ...
                  if (fullTypeName!=null){
                    ...
                    java.lang.String type = fullTypeName.substring(fullTypeName.indexOf(":")+1);
                            ...
                            if (!"viewSubAdminDetail".equals(type)){
                                //find namespace for the prefix
                                java.lang.String nsUri = reader.getNamespaceContext().getNamespaceURI(nsPrefix);
                                return (ViewSubAdminDetail)bio.web.service.ExtensionMapper.getTypeObject(
                                     nsUri,type,reader);
                              }
