 ...
 */
            ...
            /**
            *  ViewSubUsersBase bean class
            */
            @SuppressWarnings({"unchecked","unused"})
        
        public  class ViewSubUsersBase
                  ...
                  if (serializeType){
                   ...
                   if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)){
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           namespacePrefix+":viewSubUsersBase",
                           xmlWriter);
                   } else {
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           "viewSubUsersBase",
    ...
    public static class Factory{
        ...
        */
        public static ViewSubUsersBase parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception{
            ViewSubUsersBase object =
                new ViewSubUsersBase();
                ...
                if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance","type")!=null){
                  ...
                  if (fullTypeName!=null){
                    ...
                    java.lang.String type = fullTypeName.substring(fullTypeName.indexOf(":")+1);
                            ...
                            if (!"viewSubUsersBase".equals(type)){
                                //find namespace for the prefix
                                java.lang.String nsUri = reader.getNamespaceContext().getNamespaceURI(nsPrefix);
                                return (ViewSubUsersBase)bio.web.service.ExtensionMapper.getTypeObject(
                                     nsUri,type,reader);
                              }
