 ...
 */
            ...
            /**
            *  DelFileServer bean class
            */
            @SuppressWarnings({"unchecked","unused"})
        
        public  class DelFileServer
    ...
    public static class Factory{
        ...
        */
        public static DelFileServer parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception{
            DelFileServer object =
                new DelFileServer();
                ...
                if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance","type")!=null){
                  ...
                  if (fullTypeName!=null){
                    ...
                    java.lang.String type = fullTypeName.substring(fullTypeName.indexOf(":")+1);
                            ...
                            if (!"delFileServer".equals(type)){
                                //find namespace for the prefix
                                java.lang.String nsUri = reader.getNamespaceContext().getNamespaceURI(nsPrefix);
                                return (DelFileServer)bio.web.service.ExtensionMapper.getTypeObject(
                                     nsUri,type,reader);
                              }
