 ...
 */
            ...
            /**
            *  ViewSubUserDetail bean class
            */
            @SuppressWarnings({"unchecked","unused"})
        
        public  class ViewSubUserDetail
                  ...
                  if (serializeType){
                   ...
                   if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)){
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           namespacePrefix+":viewSubUserDetail",
                           xmlWriter);
                   } else {
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           "viewSubUserDetail",
    ...
    public static class Factory{
        ...
        */
        public static ViewSubUserDetail parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception{
            ViewSubUserDetail object =
                new ViewSubUserDetail();
                ...
                if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance","type")!=null){
                  ...
                  if (fullTypeName!=null){
                    ...
                    java.lang.String type = fullTypeName.substring(fullTypeName.indexOf(":")+1);
                            ...
                            if (!"viewSubUserDetail".equals(type)){
                                //find namespace for the prefix
                                java.lang.String nsUri = reader.getNamespaceContext().getNamespaceURI(nsPrefix);
                                return (ViewSubUserDetail)bio.web.service.ExtensionMapper.getTypeObject(
                                     nsUri,type,reader);
                              }
