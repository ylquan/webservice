 ...
 */
            ...
            /**
            *  ViewUserSystem bean class
            */
            @SuppressWarnings({"unchecked","unused"})
        
        public  class ViewUserSystem
                  ...
                  if (serializeType){
                   ...
                   if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)){
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           namespacePrefix+":viewUserSystem",
                           xmlWriter);
                   } else {
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           "viewUserSystem",
    ...
    public static class Factory{
        ...
        */
        public static ViewUserSystem parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception{
            ViewUserSystem object =
                new ViewUserSystem();
                ...
                if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance","type")!=null){
                  ...
                  if (fullTypeName!=null){
                    ...
                    java.lang.String type = fullTypeName.substring(fullTypeName.indexOf(":")+1);
                            ...
                            if (!"viewUserSystem".equals(type)){
                                //find namespace for the prefix
                                java.lang.String nsUri = reader.getNamespaceContext().getNamespaceURI(nsPrefix);
                                return (ViewUserSystem)bio.web.service.ExtensionMapper.getTypeObject(
                                     nsUri,type,reader);
                              }
