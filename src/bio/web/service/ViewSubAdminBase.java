 ...
 */
            ...
            /**
            *  ViewSubAdminBase bean class
            */
            @SuppressWarnings({"unchecked","unused"})
        
        public  class ViewSubAdminBase
                  ...
                  if (serializeType){
                   ...
                   if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)){
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           namespacePrefix+":viewSubAdminBase",
                           xmlWriter);
                   } else {
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           "viewSubAdminBase",
    ...
    public static class Factory{
        ...
        */
        public static ViewSubAdminBase parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception{
            ViewSubAdminBase object =
                new ViewSubAdminBase();
                ...
                if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance","type")!=null){
                  ...
                  if (fullTypeName!=null){
                    ...
                    java.lang.String type = fullTypeName.substring(fullTypeName.indexOf(":")+1);
                            ...
                            if (!"viewSubAdminBase".equals(type)){
                                //find namespace for the prefix
                                java.lang.String nsUri = reader.getNamespaceContext().getNamespaceURI(nsPrefix);
                                return (ViewSubAdminBase)bio.web.service.ExtensionMapper.getTypeObject(
                                     nsUri,type,reader);
                              }
