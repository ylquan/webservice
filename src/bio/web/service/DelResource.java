 ...
 */
            ...
            /**
            *  DelResource bean class
            */
            @SuppressWarnings({"unchecked","unused"})
        
        public  class DelResource
    ...
    public static class Factory{
        ...
        */
        public static DelResource parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception{
            DelResource object =
                new DelResource();
                ...
                if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance","type")!=null){
                  ...
                  if (fullTypeName!=null){
                    ...
                    java.lang.String type = fullTypeName.substring(fullTypeName.indexOf(":")+1);
                            ...
                            if (!"delResource".equals(type)){
                                //find namespace for the prefix
                                java.lang.String nsUri = reader.getNamespaceContext().getNamespaceURI(nsPrefix);
                                return (DelResource)bio.web.service.ExtensionMapper.getTypeObject(
                                     nsUri,type,reader);
                              }
